...
module coproc #(
	...
	parameter int unsigned N_BANKS_MAC                 = 8 , // number of banks
	parameter int unsigned N_ELEMENTS_BANK_MAC[N_BANKS_MAC] = '{32'd2, 32'd2, 32'd34, 32'd34, 32'd4, 32'd4, 32'd34, 32'd2}, // number of elements per bank
	parameter int unsigned N_ELEMENTS_BANK_MAX_MAC     = 34, // maximum elements among the banks defined above
	parameter int unsigned WIDTH_DATA_MAC[N_BANKS_MAC] = '{32'd16, 32'd16, 32'd16, 32'd16, 32'd16, 32'd16, 32'd21, 32'd23}, // data parallelism per bank
	parameter int unsigned WIDTH_DATA_NOSIMD_MAX_MAC   = 23, // maximum parallelism for non-simd data
	parameter int unsigned WIDTH_DATA_SIMD_MAX_MAC     = 0 , // maximum parallelism for simd data
	parameter int unsigned WIDTH_DATA_MAX_MAC          = 23, // maximum data parallelism among the banks defined above
	...
	parameter int unsigned WIDTH_COEFFS_SIMD_MAX_MAC   = 0 , // maximum parallelism for simd coeffs
...
//	
//	 Revision: 1.1 Tue Jul 18 14:59:13 2023 nxf99772
//	 Output Modifier in the processing chain
//	
//	 Revision: 1.13 Mon Oct 24 10:29:44 2022 nxf87116
//	 Added some comments.
//	
//	 Revision: 1.12 Wed Oct 12 00:54:42 2022 nxf87116
