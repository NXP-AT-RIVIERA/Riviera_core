...
module coproc #(
	...
	parameter int unsigned N_ELEMENTS_BANK_MAC[N_BANKS_MAC] = '{32'd4, 32'd16, 32'd2, 32'd16}, // number of elements per bank
	parameter int unsigned N_ELEMENTS_BANK_MAX_MAC          = 16, // maximum elements among the banks defined above
	parameter int unsigned WIDTH_DATA_MAC[N_BANKS_MAC]      = '{32'd32, 32'd32, 32'd32, 32'd32}, // data parallelism per bank
	...
	parameter int unsigned WIDTH_COEFFS_MAC[N_BANKS_MAC]    = '{32'd16, 32'd16, 32'd16, 32'd8}, // coeffs parallelism per bank
